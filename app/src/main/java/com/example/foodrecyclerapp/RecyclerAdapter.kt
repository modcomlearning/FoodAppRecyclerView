...
class RecyclerAdapter(var context: Context) : RecyclerView.Adapter<RecyclerAdapter.ViewHolder>() {
    // Array of Food titles    
     val titles = arrayOf("Burger",
            "Fish Fillet", "Breakfast", "Snacks",
            "Chinese", "Spaghetti", "Rice",
            "Freshy")
    // Array of Food Details  
     val details = arrayOf("Item one details This is Nice Food", "Item two details This is Nice Food",
    ...
    // Array of Food costs
     val cost = arrayOf("1,300KES", "1,100KES", "200KES", "1200KES",
